...
// Constructor is exactly the same as MSI.....
...
// this should be the same as in MSI
    ...
    if(otherState){
      ...
      /*Other cache has recently read the line*/
        ...
        */
        ...
        // Line was cached in exclusive state
        // change to shared
        // TODO: 
        otherState->changeStateTo(MESI_SHARED);

        /*Return a Remote Read Service indicating that 
         *1)The line was NOT SHARED (the true param)
         *2)The line was provided by otherCache 
